...
reason = f"BLOCKED: Cannot edit UI file '{basename}' without accessibility review. You MUST first delegate to accessibility-lead using the Agent tool (subagent_type: 'accessibility-lead'). After the accessibility review completes, this file will be unblocked automatically."
output = {
  "hookSpecificOutput": {
