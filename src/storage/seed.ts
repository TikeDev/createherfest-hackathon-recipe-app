...
const DEMO_RECIPES: RecipeJSON[] = [
  {
    ...
    preamble: {
      ...
      techniqueNotes: [
        "Blending the peanuts while warm gives a smoother result than blending cold.",
      ],
    },
    ingredients: [
      {
      ...
      {
        id: "ing-sm-2",
        raw: "1 medium onion, finely chopped",
        name: "onion",
        quantity: 1,
        unit: null,
      ...
      {
        id: "ing-sm-5",
        raw: "1 cup roasted unsalted peanuts, blended smooth",
      ...
      {
        id: "ing-sm-7",
        raw: "2 medium potatoes, peeled and diced",
        name: "potatoes",
        quantity: 2,
        unit: null,
      ...
      {
        id: "ing-sm-8",
        raw: "450g chicken thighs, cut into bite-sized pieces",
        name: "chicken thighs",
        quantity: 450,
        unit: "g",
    ...
    steps: [
      ...
      },
      {
        ...
        isCritical: false,
        annotations: [
          { type: "tip", text: "Keep the heat at medium — garlic burns quickly and turns bitter." },
        ],
      },
      {
        id: "step-sm-4",
      ...
      },
      {
        ...
        annotations: [
          {
            type: "technique",
            text: "Simmer, not boil — a hard boil can make the peanut base separate.",
          },
        ],
      },
      {
...

  {
    ...
    ingredients: [
      {
        id: "ing-dt-1",
        raw: "1 cup yellow lentils (toor dal or moong dal), rinsed",
        name: "yellow lentils",
        quantity: 1,
        unit: "cup",
      ...
      {
        id: "ing-dt-4",
        raw: "2 tablespoons ghee or neutral oil",
        name: "ghee",
        quantity: 2,
        unit: "tablespoon",
      ...
      {
        id: "ing-dt-8",
        raw: "1-inch piece fresh ginger, grated",
        name: "fresh ginger",
        quantity: 1,
        unit: "inch",
        units: [
          {
            original: "1-inch piece",
            grams: 8,
      ...
      {
        id: "ing-dt-10",
        raw: "1 teaspoon ground coriander",
      ...
      {
        id: "ing-dt-11",
        raw: "½ teaspoon red chili powder (or to taste)",
      ...
      {
        id: "ing-dt-14",
        raw: "1 lemon, cut into wedges for serving",
        name: "lemon",
        quantity: 1,
        unit: null,
    ...
    steps: [
      {
        ...
        annotations: [
          {
            type: "tip",
            text: "Rinsing removes surface starch that causes foaming during cooking.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        annotations: [
          {
            type: "technique",
            text: "This is the tadka (tempering). The sizzle means the fat is hot enough to bloom the spice. If there's no sizzle, wait another 30 seconds.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        annotations: [
          {
            type: "tip",
            text: "Do this right before serving — the spices are most fragrant when fresh.",
          },
        ],
      },
      {
...

  {
    ...
    preamble: {
      ...
      techniqueNotes: [
        "Mashing the potatoes in the broth (rather than separately) is what gives caldo verde its characteristic silky-thick texture.",
      ],
    },
    ingredients: [
      {
        id: "ing-cv-1",
        raw: "2 tablespoons olive oil, plus more to serve",
        name: "olive oil",
        quantity: 2,
        unit: "tablespoon",
      ...
      {
        id: "ing-cv-2",
        raw: "1 medium onion, thinly sliced",
        name: "onion",
        quantity: 1,
        unit: null,
        units: [{ original: "1 medium", grams: 150, confidenceLevel: "high" }],
      ...
      {
        id: "ing-cv-4",
        raw: "4 medium potatoes, peeled and roughly sliced",
        name: "potatoes",
        quantity: 4,
        unit: null,
      ...
      {
        id: "ing-cv-5",
        raw: "5 cups chicken or vegetable broth",
        name: "broth",
        quantity: 5,
        unit: "cup",
      ...
      {
        id: "ing-cv-6",
        raw: "200g kale or collard greens, very finely shredded",
        name: "kale",
        quantity: 200,
        unit: "g",
      ...
      {
        id: "ing-cv-7",
        raw: "150g chouriço, thinly sliced (optional)",
        name: "chouriço",
        quantity: 150,
        unit: "g",
    ...
    steps: [
      ...
      },
      {
        ...
        annotations: [
          {
            type: "tip",
            text: "The potatoes should be very soft — almost disintegrating. This is what makes the soup thick.",
          },
        ],
      },
      {
        ...
        annotations: [
          {
            type: "technique",
            text: "For a rustic texture, mash roughly with a fork. For a silky soup, use an immersion blender directly in the pot.",
          },
        ],
      },
      {
  ...
  // Quick, minimal-tool Japanese comfort food. Tests: soy allergen.
  {
    ...
    preamble: {
      ...
      techniqueNotes: [
        "Miso must be added off the heat. Boiling destroys its flavour compounds and probiotic cultures.",
      ],
    },
    ingredients: [
      {
        id: "ing-ms-1",
        raw: "4 cups dashi stock or vegetable broth",
        name: "dashi stock",
        quantity: 4,
        unit: "cup",
        units: [{ original: "4 cups", mlEquivalent: 950, confidenceLevel: "high" }],
      ...
      {
        id: "ing-ms-2",
        raw: "3 tablespoons white or red miso paste",
        name: "miso paste",
        quantity: 3,
        unit: "tablespoon",
      ...
      {
        id: "ing-ms-3",
        raw: "150g silken tofu, cut into small cubes",
        name: "silken tofu",
        quantity: 150,
        unit: "g",
        units: [{ original: "150g", grams: 150, confidenceLevel: "high" }],
      ...
      {
        id: "ing-ms-4",
        raw: "1 tablespoon dried wakame seaweed",
        name: "dried wakame",
        quantity: 1,
        unit: "tablespoon",
        units: [
      ...
      {
        id: "ing-ms-5",
        raw: "2 green onions, thinly sliced",
        name: "green onions",
        quantity: 2,
        unit: null,
    ...
    steps: [
      {
        ...
        isCritical: false,
        annotations: [
          { type: "tip", text: "Wakame expands 5–6× its dry volume — don't use too much." },
        ],
      },
      {
        id: "step-ms-2",
      ...
      },
      {
        ...
        annotations: [
          {
            type: "technique",
            text: "Dissolving miso in a ladle first prevents lumps and ensures it disperses evenly.",
          },
        ],
      },
      {
  ...
  // One-pan Middle Eastern eggs in spiced tomato sauce. Tests: egg allergen.
  {
    ...
    preamble: {
      ...
      techniqueNotes: [
        "Making wells in the sauce lets you control exactly where each egg lands. The well holds the egg in place while the white sets.",
      ],
    },
    ingredients: [
      {
      ...
      {
        id: "ing-sk-7",
        raw: "400g canned crushed tomatoes (one standard tin)",
      ...
      {
        id: "ing-sk-10",
        raw: "Fresh parsley or cilantro, to garnish",
        name: "fresh parsley",
        quantity: null,
        unit: null,
        units: [{ original: "to garnish", confidenceLevel: "high" }],
    ...
    steps: [
      ...
      },
      {
        ...
        annotations: [
          {
            type: "tip",
            text: "Don't let the garlic brown — it turns bitter. Keep the heat at medium.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        annotations: [
          {
            type: "technique",
            text: "Crack eggs into a small cup first — it's easier to lower them in without breaking the yolk.",
          },
        ],
      },
      {
        ...
        isCritical: true,
        criticalNote:
          "Watch closely — eggs continue cooking off the heat. Remove at 5 min for runny yolks, 8 min for fully set.",
        annotations: [],
      },
      {
        id: "step-sk-6",
  ...
  // Timing-critical Italian pasta. Tests: egg + dairy allergens, stovetop restriction.
  {
    ...
    ingredients: [
      {
        id: "ing-pc-1",
        raw: "400g spaghetti or rigatoni",
        name: "spaghetti",
        quantity: 400,
        unit: "g",
        units: [{ original: "400g", grams: 400, confidenceLevel: "high" }],
      ...
      {
        id: "ing-pc-2",
        raw: "150g pancetta or guanciale, diced",
        name: "pancetta",
        quantity: 150,
        unit: "g",
        units: [{ original: "150g", grams: 150, confidenceLevel: "high" }],
      ...
      {
        id: "ing-pc-5",
        raw: "80g Pecorino Romano or Parmesan, very finely grated",
      ...
      {
        id: "ing-pc-6",
        raw: "Generous amount of freshly cracked black pepper",
        name: "black pepper",
        quantity: null,
        unit: null,
        units: [{ original: "to taste", confidenceLevel: "high" }],
    ...
    steps: [
      {
        ...
        annotations: [
          {
            type: "tip",
            text: "The water should taste noticeably salty — about 1 tablespoon of salt per litre.",
          },
        ],
      },
      {
        ...
        annotations: [
          {
            type: "technique",
            text: "Mixing the eggs and cheese into a paste first means it will emulsify more evenly when it hits the hot pasta.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        isCritical: true,
        criticalNote:
          "The pasta water is essential — without it, the sauce will be too thick and won't coat the pasta properly.",
        annotations: [],
      },
      {
        id: "step-pc-5",
      ...
      },
      {
        ...
        isCritical: true,
        criticalNote:
          "Never return the pan to direct heat after adding the eggs — they will scramble immediately. The residual heat from the pasta is exactly enough.",
        annotations: [
          {
            type: "technique",
            text: "Adding pasta water gradually controls the temperature and prevents the eggs from curdling. Toss fast and continuously.",
          },
        ],
      },
      {
